...
print "Len Datapoints: ", len(enron_data)
...
enron_keyPOIPayment = dict(
    (k, enron_data[k]['total_payments']) for k in ("LAY KENNETH L", "SKILLING JEFFREY K", "FASTOW ANDREW S"))
...
print "NaN for total payment and percentage:", total_payments_unavailable, float(total_payments_unavailable) / len(
    enron_data) * 100
print "NaN for total payment of POI and percentage:", total_payments_unavailable_poi, float(
